...
<body class="cbp-spmenu-push">
	...
	<div class='tables'>
		...
		<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
			<h4>档案模板列表</h4>
			<form action="/filemanage/index.php/Home/FileTemp/showList" method="GET">
			
				<div class='row'>
					<div class='col-sm-3'>
							<input class="sb-search-input input__field--madoka" value="<?php echo ($searchValue); ?>" placeholder="模板名称" type="text" name='searchValue'>
					</div>
					<div class='col-sm-2'>
			...
			<table class="table table-bordered"> 
					...
					<tbody> 
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr> 
                			...
                			<a <?php if($my_detail_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/FileTemp/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a>
                		
           					
           			
           					<a <?php if($my_modify_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/FileTemp/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_modify_btn btn btn-primary">修改</a>
           		
           				
           					<a <?php if($my_del_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/FileTemp/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    class=" my_del_btn btn btn-danger  delete">删除</a>
