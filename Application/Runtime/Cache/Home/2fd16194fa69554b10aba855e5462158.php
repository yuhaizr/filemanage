...
<body class="cbp-spmenu-push">
	...
	<div class="panel-body widget-shadow">
		...
		<div class="form-body col-sm-8">
			<!-- <form class="form-horizontal" action="/filemanage/index.php/Home/Student/add" method="POST"> -->
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' >
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input disabled="disabled" type="text" required="required" id="number" name="number" value="<?php echo ($info['number']); ?>" class="form-control"   placeholder="学号"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"> 
						 </div> 
					 </div>
				 </div>					 
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						    <select disabled="disabled" id='class_id_select' name='class_id' >
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<textarea disabled="disabled" name='activity' id='activity' rows="10" cols="100" ><?php echo ($info["activity"]); ?></textarea> 
						 </div> 
					 </div>
				 </div>					 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea disabled="disabled" name='award_punishment' id='award_punishment' rows="10" cols="100" ><?php echo ($info["award_punishment"]); ?></textarea>
						 </div> 
					 </div>
				 </div>		
