	...
	<div class='tables'>
		...
		<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
                ...
                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                    ...
                    <tbody>
						<?php if(is_array($roleinfolist)): foreach($roleinfolist as $key=>$vo): ?><tr>
								<td><?php echo ($key+1); ?></td>
								<td><?php echo ($vo["name"]); ?></td>
								<td><?php echo ($vo["remark"]); ?></td>
								<td>
                               	<!-- <a href="/filemanage/index.php/Home/Role/roleEdit?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 编辑</a> -->
                               	<a href="/filemanage/index.php/Home/Role/roleAuth?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 授权</a>
                                <a href="/filemanage/index.php/Home/Role/roleUserList?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 用户列表</a>
                                <!-- <a href="/filemanage/index.php/Home/Role/Roledelete?id=<?php echo ($value["id"]); ?>" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> 删除</a> -->
                            </td>
