			...
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' >
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input disabled="disabled" type="text" required="required" id="name" name="name" value="<?php echo ($info['name']); ?>" class="form-control"   placeholder="姓名"> 
						 </div> 
					 </div>
				 </div>
				  <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input  disabled="disabled"  type="text" required="required" id="number" name="number"  class="form-control"   placeholder="工号"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"> 
						 </div> 
					 </div>
				 </div>	
				  ...
				  <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<select  disabled="disabled"  id='sex_select' name='sex' class=''>
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input  disabled="disabled"  type="date" required="required" name='birthday' id="birthday" value="<?php echo ($info['birthday']); ?>" class="form-control"  placeholder="出生日期"> 
						 </div> 
					 </div>
				 </div>
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input  disabled="disabled"  type="text" required="required" name='political' id="political" value="<?php echo ($info['political']); ?>" class="form-control"  placeholder="政治面貌"> 
						 </div> 
					 </div>
				 </div>
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input  disabled="disabled"  type="text" required="required" name='phone' id="phone" value="<?php echo ($info['phone']); ?>" class="form-control"  placeholder="联系电话"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"> 
						 </div> 
					 </div>
				 </div>
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input  disabled="disabled"  type="text" required="required" name='addr' id="addr" value="<?php echo ($info['addr']); ?>" class="form-control"  placeholder="家庭住址"> 
						 </div> 
					 </div>
				 </div>	
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						    <select  disabled="disabled"  id='teacherlevel_select' name='level' class=''>
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input  disabled="disabled"  type="text"  name='agency' id="agency" value="<?php echo ($info['agency']); ?>" class="form-control"  placeholder="教师教学发展机构"> 
						 </div> 
					 </div>
				 </div>					 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea  disabled="disabled"  name='trade_learn_status' id='trade_learn_status' rows="10" cols="100" ><?php echo ($info["trade_learn_status"]); ?></textarea>
						 </div> 
					 </div>
				 </div>						 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea  disabled="disabled"  name='scientific_project_status' id='scientific_project_status' rows="10" cols="100" ><?php echo ($info["scientific_project_status"]); ?></textarea>
						 </div> 
					 </div>
				 </div>					 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea  disabled="disabled"  name='reward_status' id='reward _status' rows="10" cols="100" ><?php echo ($info["reward_status"]); ?></textarea>
						 </div> 
					 </div>
				 </div>					 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea  disabled="disabled"  name='paper_status' id='paper_status' rows="10" cols="100" ><?php echo ($info["paper_status"]); ?></textarea>
						 </div> 
					 </div>
				 </div>						 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea  disabled="disabled"  name='publication_status' id='publication_status' rows="10" cols="100" ><?php echo ($info["publication_status"]); ?></textarea>
						 </div> 
					 </div>
				 </div>						 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea  disabled="disabled"  name='patent_status' id='patent_status' rows="10" cols="100" ><?php echo ($info["patent_status"]); ?></textarea>
						 </div> 
					 </div>
				 </div>						 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea  disabled="disabled"  name='teaching_material_status' id='teaching_material_status' rows="10" cols="100" ><?php echo ($info["teaching_material_status"]); ?></textarea>
						 </div> 
					 </div>
				 </div>					 
