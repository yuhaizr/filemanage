...
<body class="cbp-spmenu-push">
	...
	<div class='tables'>
		...
		<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
			<h4>成绩排名</h4>
			<form action="/filemanage/index.php/Home/Count/rankCount" method="GET">
				...
				<div class='row'>
					  ...
					  <div class="col-sm-1"> 
                            <div class="input-group">
                                     <input  class="form-control yearView"  name='year' id='year' value="<?php echo ($info['year']); ?>" type="text"  placeholder="届(年)">
					...
					<div class="col-sm-2"> 
					 ...
					 <div class="col-sm-3"> 
					    <select   id='class_id_select' name='class_id' >
					    	<option value=''> 年级排名</option>
					    	<?php if(is_array($classList)): foreach($classList as $key=>$vo): ?><option <?php if( $info['class_id'] == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?>排名</option><?php endforeach; endif; ?>
          ...
          <table class="table table-striped table-hover table-bordered" id="editabledatatable">
		        ...
		        <!--         			<td>
              						...
              						<a <?php if($my_detail_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/Count/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a>
           							<a <?php if($my_modify_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/Count/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_modify_btn btn btn-primary">修改</a>
           							<a <?php if($my_del_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/Count/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    class=" my_del_btn btn btn-danger  delete">删除</a>
