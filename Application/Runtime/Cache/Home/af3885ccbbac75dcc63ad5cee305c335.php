...
<body class="cbp-spmenu-push">
	...
	<div class="panel-body widget-shadow">
		...
		<div class="form-body col-sm-8">
			<form class="form-horizontal" action="/filemanage/index.php/Home/Course/save" method="POST">
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' >
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text" required="required" id="name" name="name" value="<?php echo ($info['name']); ?>" class="form-control"   placeholder="课程名称"> 
						 </div> 
					 </div>
				 </div>
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	 <select id='' required="required" name='type' >
