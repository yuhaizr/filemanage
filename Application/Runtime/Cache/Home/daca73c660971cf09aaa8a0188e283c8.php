...
<body class="cbp-spmenu-push">
	...
	<div class="panel-body widget-shadow">
		...
		<div class="form-body col-sm-8">
			<form class="form-horizontal" action="/filemanage/index.php/Home/ClassManage/save" method="POST">
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' >
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text" required="required" id="name" name="name" value="<?php echo ($info['name']); ?>" class="form-control"   placeholder="班级名称"> 
						 </div> 
					 </div>
				 </div>
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 <label for="name" class="col-sm-3 control-label">届(年)</label>
						 <div class="col-sm-6"> 
                               <div class="input-group">
                                        <input class="form-control yearView" required="required" name='year' value="<?php echo ($info["year"]); ?>" type="text" >
...
$(document).ready(function () {
	...
	$('.yearView').datetimepicker('setEndDate', '2016');
});
