...
<body class="cbp-spmenu-push">
	...
	<!-- 		<form class="form-horizontal" action="/filemanage/index.php/Home/Course/add" method="POST">
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' > -->
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text" disabled="disabled" required="required" id="name" name="name" value="<?php echo ($info['name']); ?>" class="form-control"   placeholder="课程名称"> 
						 </div> 
					 </div>
				 </div>
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	 <select  disabled="disabled" id='' required="required" name='type' >
						    	<option value=''> 请选择课程类型</option>
						    	
						    		<option <?php if( $info['type'] == '1' ): ?>selected="selected"<?php endif; ?> value='1'>普通课程</option>
						   			<option <?php if( $info['type'] == '2' ): ?>selected="selected"<?php endif; ?> value='2'>证书考试</option>
