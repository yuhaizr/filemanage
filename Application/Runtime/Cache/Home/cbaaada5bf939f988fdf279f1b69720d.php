...
<body class="cbp-spmenu-push">
	...
	<div class="panel-body widget-shadow">
		...
		<div class="form-body col-sm-8">
			<form class="form-horizontal" action="/filemanage/index.php/Home/Admin/save" method="POST">
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' >
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text" required="required" id="account" name="account" value="<?php echo ($info['account']); ?>" class="form-control"   placeholder="学请输入登入账号" onkeyup="value=value.replace(/[\W]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" > 
						 </div> 
					 </div>
				 </div>				 
