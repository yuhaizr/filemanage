			...
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' >
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text" required="required" value="<?php echo ($info['title']); ?>" class="form-control" id="title" name='title' placeholder="档案模板名称"> 
						 </div> 
					 </div>
				 </div>
				  <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text"  class="form-control" value="<?php echo ($info['mark']); ?>" id="mark" name='mark' placeholder="备注"> 
						 </div> 
					 </div>
				 </div>  
				 <hr>
				 ...
				 <div id="fieldList">
				 	...
				 	<?php if(is_array($info["name"])): foreach($info["name"] as $key=>$vo): ?><div class='row feild-item'>
				 		<div class=' col-sm-offset-2  col-sm-2'>
				 			<input type="text" required="required" class="form-control keyinput" value="<?php echo ($key); ?>" name='key[]' placeholder="列名">
				 		</div>
				 		<div class="col-sm-6">
				 			<div class="input-group">
				 			<input type="text" required="required" class="form-control nameinput" value=<?php echo ($vo); ?> name='name[]' placeholder="列名">
