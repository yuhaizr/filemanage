...
<body class="cbp-spmenu-push">
	...
	<div class="panel-body widget-shadow">
		...
		<div class="form-body col-sm-8">
			<form class="form-horizontal" action="/filemanage/index.php/Home/Course/saveScore?type=add" method="POST">
	...
	<script>
		$(function(){
			$("#class_id_select").change(function(){
					...
					location.href = "/filemanage/index.php/Home/Course/addScore?type=menu&course_id="+course_id+"&class_id="+class_id+"&student_id="+student_id;
			});
