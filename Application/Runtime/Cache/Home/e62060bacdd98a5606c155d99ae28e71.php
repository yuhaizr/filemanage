...
<body class="cbp-spmenu-push">
	...
	<div class='tables'>
		...
		<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
			<h4>学生成绩波动分析</h4>
			<form action="/filemanage/index.php/Home/Count/changeCount" method="get">
			<div class='row'>
				<div class="col-sm-3"> 
				    <select  required="required" id='student_id_select' name='student_id' >
				  
				    	<?php if(is_array($studentList)): foreach($studentList as $key=>$vo): ?><option <?php if( $info['id'] == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?>(<?php echo ($vo["id"]); ?>)</option><?php endforeach; endif; ?>
