...
<body class="cbp-spmenu-push">
	...
	<div class='tables'>
		...
		<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
			<h4>教师列表</h4>
			<form action="/filemanage/index.php/Home/Teacher/showList" method="GET">
			
				<div class='row'>

					<div class='col-sm-3'>
						<input type="text"  name="searchValue" value="<?php echo ($searchValue); ?>" id="searchValue" class="form-control nameinput" placeholder="请输入您要搜索的教师的姓名"> 
					</div>
					<div class='col-sm-2'>
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                			...
		                			<td>
              						...
              						<a <?php if($my_detail_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/Teacher/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a>
           							<a <?php if($my_modify_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/Teacher/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_modify_btn btn btn-primary">修改</a>
           							<a <?php if($my_del_btn != 1): ?>style="display: none;"<?php endif; ?> href="/filemanage/index.php/Home/Teacher/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    class=" my_del_btn btn btn-danger  delete">删除</a>
