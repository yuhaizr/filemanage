				 ...
				 <div class='row'>
				  ...
				  <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
								<input type="text" name='score' id='score' required="required" class="form-control" value="<?php echo ($info['score']); ?>"  onkeyup="value=value.replace(/[^\d+\.]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d+\.]/g,''))" >
