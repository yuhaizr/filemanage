...
<body class="cbp-spmenu-push">
	...
	<div class="panel-body widget-shadow">
		...
		<div class="form-body col-sm-8">
			<form class="form-horizontal" action="/filemanage/index.php/Home/FileTemp/add" method="POST">
				 <div class='row'>
					 <div class="form-group "> 
						 <label for="name" class="col-sm-3 control-label">档案模板名称</label>
						 <div class="col-sm-6"> 
						 	<input type="text" required="required" class="form-control" id="title" name='title' placeholder="档案模板名称"> 
						 </div> 
					 </div>
				 </div>
				  <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text"  class="form-control" id="mark" name='mark' placeholder="备注"> 
						 </div> 
					 </div>
				 </div>  
				 <hr>
				 ...
				 <div id="fieldList">
				 	<div class='row feild-item'>
				 		<div class=' col-sm-offset-2  col-sm-2'>
				 			<input type="text" required="required" class="form-control keyinput" name='key[]' placeholder="列名标记" onkeyup="value=value.replace(/[^\a-zA-Z]/g,'')" >
				 		</div>
				 		<div class="col-sm-6">
