			...
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' >
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text" required="required" id="number" name="number" value="<?php echo ($info['number']); ?>" class="form-control"   placeholder="学号"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"> 
						 </div> 
					 </div>
				 </div>					 
...
<!-- 				<div class='row'>	
					 <div class="form-group "> 
						 <label for="name" class="col-sm-3 control-label">入学年份</label> 
						 <div class="col-sm-6"> 
				 ...
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<textarea name='activity' id='activity' rows="10" cols="100" ><?php echo ($info["activity"]); ?></textarea> 
						 </div> 
					 </div>
				 </div>					 
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	...
						 	<textarea name='award_punishment' id='award_punishment' rows="10" cols="100" ><?php echo ($info["award_punishment"]); ?></textarea>
						 </div> 
					 </div>
				 </div>		
