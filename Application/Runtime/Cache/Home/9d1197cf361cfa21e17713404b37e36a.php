...
<body class="cbp-spmenu-push">
	...
	<div class="panel-body widget-shadow">
		...
		<div class="form-body col-sm-8">
			<form class="form-horizontal" action="/filemanage/index.php/Home/TeacherCourse/save?type=add" method="POST">
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' >
					 ...
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-3"> 
                               <div class="input-group">
                                        <input class="form-control yearView" required="required" name='year' id='year' value="<?php echo ($info['year']); ?>" type="text" >
				 ...
				 <div class='row'>
				  ...
				  <div class='row'>
					 <div class="form-group "> 
						 <label for="name" class="col-sm-3 control-label">教师</label>
					     <div class="col-sm-6"> 
						    <select required="required" id='teacher_id_select' name='teacher_id' >
						    	<option value=''> 请选择教师</option>
						    	<?php if(is_array($teacherList)): foreach($teacherList as $key=>$vo): ?><option <?php if( $info['teacher_id'] == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
