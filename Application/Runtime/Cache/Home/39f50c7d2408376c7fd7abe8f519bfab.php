...
<body class="cbp-spmenu-push">
	...
	<!-- 		<form class="form-horizontal" action="/filemanage/index.php/Home/ClassManage/add" method="POST">
			<input type="hidden" value="<?php echo ($info['id']); ?>" class="form-control" id="id" name='id' > -->
				 <div class='row'>
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
						 	<input type="text" disabled="disabled" required="required" id="name" name="name" value="<?php echo ($info['name']); ?>" class="form-control"   placeholder="班级名称"> 
						 </div> 
					 </div>
				 </div>
					 ...
					 <div class="form-group "> 
						 ...
						 <div class="col-sm-6"> 
                               <div class="input-group">
                                        <input disabled="disabled" class="form-control yearView" required="required" name='year' value="<?php echo ($info["year"]); ?>" type="text" >
